...
<html>
  <head>
    ...
    <title>Welcome <?php echo $this->session->userdata("student_prefix").". ".$this->session->userdata("student_firstname")." ".$this->session->userdata("student_lastname"); ?></title>
  ...
  <body>
    <?php $this->load->view("template/member/menu"); ?>
